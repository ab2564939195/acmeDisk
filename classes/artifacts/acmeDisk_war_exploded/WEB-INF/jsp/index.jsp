...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到一号店！<a href="${pageContext.request.contextPath}/login/toLogin">请登录</a> | <a href="${pageContext.request.contextPath}/register/toRegister">免费注册</a></div>
				<div class="tbar_rgt">
					<ul>
							...
							<div class="rgt-box">
								<div class="loginbox">
									<div class="login_icon cf">
										<ul>
											<li><a href="${pageContext.request.contextPath}/register/toRegister">免费注册</a></li>
											<li><a href="${pageContext.request.contextPath}/login/toLogin">用户登录</a></li>
										</ul>
									</div>

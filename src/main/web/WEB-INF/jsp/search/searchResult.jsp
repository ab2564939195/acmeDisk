...
<head>
    ...
    <!--[if IE 6]>
    <link href="<%=request.getContextPath()%>/statics/css/main.ie6.css" rel="stylesheet" type="text/css" />
    <![endif]-->
    <!--[if IE 7]>
...
<div id="doc">
    <div id="s_hdw">
        ...
        <div class="mmenu">
            <div class="s_hd">
                <div id="s_search">
                    <form action="" id="searchForm" method="post"><input name="searchInfo" type="text" class="search-input" value="${searchString}" /><input name="" type="image" src="<%=request.getContextPath()%>/statics/images/btn_search.jpg" id="searchButton"/></form>
                </div>
    ...
    <link type="text/css" href="<%=request.getContextPath()%>/statics/css/list.css" rel="stylesheet" />
    ...
    <div id="s_bdw">
        <div id="s_bd">
            ...
            <div class="f-l leftlist">
                ...
                <div class="ladv"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/2asd.jpg" width="205" height="72" alt="" /></a></div>

                <div class="ladv"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/12ad.jpg" width="205" height="72" alt="" /></a></div>

                <div class="ladv"><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21af.jpg" width="205" height="72" alt="" /></a></div>
                ...
                <div class="Toplist">
                    ...
                    <div class="Topcon">
                        <ul>
                            <li>
                                <a href="#"><img src="<%=request.getContextPath()%>/statics/images/124ad.jpg" width="58" height="58" alt="" /></a>
                ...
                <div class="Toplist">
                    ...
                    <div class="browselist">
                        <ul class="cf">
                            <li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21da.jpg" width="58" height="58" alt="" /></a></li>
                            <li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21da.jpg" width="58" height="58" alt="" /></a></li>
                            <li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21da.jpg" width="58" height="58" alt="" /></a></li>
                            <li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21da.jpg" width="58" height="58" alt="" /></a></li>
                            <li><a href="#"><img src="<%=request.getContextPath()%>/statics/images/21da.jpg" width="58" height="58" alt="" /></a></li>
            ...
            <div class="f-r rightlist">
                ...
                <div class="hotbox cf">
                    <div class="f-l hotcon">
                        ...
                        <ul class="cf">
                            ...
                            <li>
                                <a href="#"><img src="<%=request.getContextPath()%>/statics/images/21ad.jpg" width="115" height="115" alt="" /></a>
                                <dl>
                            ...
                            <li>
                                <a href="#"><img src="<%=request.getContextPath()%>/statics/images/214ad.jpg" width="115" height="115" alt="" /></a>
                                <dl>
                                    <dt><a href="#">凌仕魅动男士香氛-契合</a></dt>
                                    <dd>特价：<strong class="red">￥52.9</strong></dd>
                                    <dd><span class="startotal"></span></dd>
                ...
                <div class="productlist">
                    <%--<script type="text/javascript">--%>
                        ...
                        <%--$(function () {--%>
                             <%--var li_list="<li>--%>
                                 <%--<a href='#'><img src='<%=request.getContextPath()%>/statics/images/21asfa.jpg' width='170' height='160' alt='' /></a>--%>
                                <%--<dl>--%>
                                <%--<dt><a href='#'>凌仕魅动男士香氛-契合</a></dt>--%>
                                <%--<dd>特价：<strong class="red">￥52.9</strong></dd>--%>
                            <%--<dd><span class="startotal"></span></dd>--%>
                    ...
                    <ul>
                        ...
                        <%--<c:forEach items="searchResult" var="list">--%>
                            <%--<li>--%>
                                <%--<a href="#"><img src="<%=request.getContextPath()%>/statics/images/21asfa.jpg" width="170" height="160" alt="" /></a>--%>
                                <%--<dl>--%>
                                    <%--<dt><a href="#">${list.commodityName}sssss</a></dt>--%>
                                    <%--<dd>特价：<strong class="red">￥${list.priceShow}sssssssss</strong></dd>--%>
                                    <%--<dd><span class="startotal"></span></dd>--%>
                                    <%--<dd><a class="addcat" href="#">加入购物车</a></dd>--%>
                                <%--</dl>--%>
                            <%--</li>--%>
                        ...
                        <li>
                            <a href="#"><img src="<%=request.getContextPath()%>/statics/images/21asfa.jpg" width="170" height="160" alt="" /></a>
                            <dl>
                                <dt><a href="#">${list.commodityName}</a></dt>
                                <dd>特价：<strong class="red">￥${list.priceShow}</strong></dd>
                                <dd><span class="startotal"></span></dd>
                                <dd><a class="addcat" href="#">加入购物车</a></dd>
                            </dl>
                        </li>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                var  num=<%=resultNum%> ;
                                if(num<=4){
                                    $("ul>li[name='buchong']").css('display','block');
                                }
                            })
               ...
               <script type="text/javascript">
                   $(function () {
                       $("#toThePage").click(function () {
                          ...
                          // alert(page);alert(searchString);
                           <%--<%String allPath=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/";--%>
                           <%--%>--%>
                           var url=location.href;
                           url=url.split('?')[0];url=url.split('/')[0]+"//"+url.split('/')[1]+url.split('/')[2]+"/";
                          // alert(url+'search'+'/'+'doSearchPage');
                          url=url+'search'+'/'+'doSearchPage';
                          location.href=url+'?'+'searchInfo='+searchString+'&pageNum='+page;
                       })
                       ...
                       $("a[href='###']").click(function () {
                         ...
                         //  alert(topage);
                           ...
                           alert(url);
                           url=url+'search'+'/'+'doSearchPage';
                           alert(url+'?searchInfo='+searchInfo+'&pageNum='+topage);
                           location.href=url+'?searchInfo='+searchInfo+'&pageNum='+topage;
                       })
                ...
                <div class="pagecon">
                    <div class="f-r pagination">
                       <a href="###" topage="${pageInfo.prePage}"
                            <c:if test="${hasPreviousPage}">disabled="disabled"</c:if>
                        > 上一页</a>
                        <c:forEach items="${pageInfo.navigatepageNums}" var="pa">
                            </span><span class="current" topage="${pa}">${pa}</span>
                        </c:forEach>
                        <%--</span><span class="current">${}</span>--%>

                        <a href="###"
                                <c:if test="${pageInfo.hasNextPage}">disabled="disabled" </c:if>
                        topage="${nextPage}"
                        >下一页 &gt;
                    </a><div class="yepage">一共${pageInfo.total}页,到第<input class="stext" type="text" name=""  value="1" id="tiaozhuan"/>页<input class="btnimg" type="button" name="" id="toThePage" value="" /></div>
                    </div><!--pagination end-->
                </div>
                <br>
                <br>
                <p style="color: red"><%=rexiao%></p>
                <div class="productlist">
                    <ul>
                        <li name="buchong" style="display: none">
                            <a href="#"><img src="<%=request.getContextPath()%>/statics/images/21asfa.jpg" width="170" height="160" alt="" /></a>
                            <dl>
                                <dt><a href="#">凌仕魅动男士香氛-契合</a></dt>
                                <dd>特价：<strong class="red">￥52.9</strong></dd>
                        ...
                        <li style="display: none" name="buchong">
                            <a href="#"><img src="<%=request.getContextPath()%>/statics/images/21asfa.jpg" width="170" height="160" alt="" /></a>
                            <dl>
                                <dt><a href="#">凌仕魅动男士香氛-契合</a></dt>
                                <dd>特价：<strong class="red">￥52.9</strong></dd>
